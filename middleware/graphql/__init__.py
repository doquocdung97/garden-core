...
from .property import schema_property
from .core import schema_core
from .media import schema_media
...
schema = merge_schema(schema_document,schema_object,schema_property,schema_core,schema_media)